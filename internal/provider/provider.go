...
import (
	...
	"github.com/eveld/terraform-provider-marketo/waypoint"
...
type providerData struct {
	ClientID     types.String `tfsdk:"hcp_client_id"`
	ClientSecret types.String `tfsdk:"hcp_client_secret"`
...
func (p *provider) Configure(ctx context.Context, req tfsdk.ConfigureProviderRequest, resp *tfsdk.ConfigureProviderResponse) {
	...
	client, err := waypoint.NewClient("https://api.hashicorp.cloud", id, secret)
	if err != nil {
		resp.Diagnostics.AddError(
			"Unable to create client",
